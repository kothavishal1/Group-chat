    ...
    public class UploadController : ControllerBase
    {
        ...
        public async Task<IActionResult> Upload([FromForm] UploadViewModel uploadViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                var group = _context.Group.Where(r => r.Id == uploadViewModel.GroupId).FirstOrDefault();
                ...
                await _hubContext.Clients.Group(group.Name).SendAsync("newMessage", messageViewModel);
